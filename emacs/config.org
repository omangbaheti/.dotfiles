...
- [[#important-programs-to-load-first][IMPORTANT PROGRAMS TO LOAD FIRST]]
  ...
  - [[#theming][Theming]]
  - [[#dashboard][DASHBOARD]]
- [[#closing-minibuffer][CLOSING MINIBUFFER]]
...
- [[#emacs-sane-defaults][EMACS SANE DEFAULTS]]
  ...
  - [[#shell-inherit-params][Shell inherit params]]
  - [[#minor-optimisations][Minor Optimisations]]
- [[#org-mode][ORG MODE]]
  - [[#evil-org][EVIL ORG]]
...
- [[#pretty-visuals][PRETTY VISUALS]]
  ...
  - [[#prettifying-text-to-icons][Prettifying text to icons]]
...
- [[#language-setup][LANGUAGE SETUP]]
  ...
  - [[#syntax-parsing---treesitter][Syntax Parsing - Treesitter]]
...
- [[#general-keybindings][General Keybindings]]
  ...
  - [[#transient][TRANSIENT]]
  - [[#casual][CASUAL]]
- [[#stuff-i-havent-used-in-a-while][Stuff I havent Used in a while]]
  - [[#deadgrep][DEADGREP]]
  - [[#zoxide][ZOXIDE]]
  - [[#vterm][Vterm]]
  - [[#neotree][NEOTREE]]
...
** Pulsar
Package to highlight a line when jumping to different places
#+begin_src emacs-lisp
(use-package pulsar
  :ensure t
  :config
...
** Winpulse
Package to highlight when switching buffer
#+begin_src emacs-lisp
...
* LANGUAGE SETUP
** Language Modes
Language Modes that I need to install manually
#+begin_src emacs-lisp
;; Nix integration
...
#+RESULTS:
: #s(hash-table data (:use-package (27126 62609 858609 985000) :use-package-secs (0 0 119 16000)))
...
#+RESULTS:
: #s(hash-table data (:use-package (27126 60948 351262 279000) :use-package-secs (0 0 22394 971000) :init (27126 60411 927356 34000) :init-secs (0 0 3 166000) :config (27126 60413 363059 683000) :config-secs (0 0 3387 194000)))
...
* Stuff I havent Used in a while
