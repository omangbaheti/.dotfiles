...
(use-package general
  ...
  (general-define-key
   ...
   "<escape>" (lambda ()
                ...
                (evil-ex-nohighlight)))
  (leader-key
    "SPC" '(consult-find :wk "Consult Find")
...
#+RESULTS:
: [nil 26833 8601 823333 nil elpaca-process-queues nil nil 45000 nil]
...
#+RESULTS:
: [nil 26841 29195 966894 nil elpaca-process-queues nil nil 274000 nil]
